...
if __name__ == "__main__":
    ...
    print(f"   This will cause: AssertionError: Expected target boxes to be a tensor of shape [N, 4], got torch.Size([0])")
    ...
    print(boxes_tensor)
    print(f"\n  Interpretation:")
    print(f"    Row 0: [x1={boxes_tensor[0,0]:.0f}, y1={boxes_tensor[0,1]:.0f}, x2={boxes_tensor[0,2]:.0f}, y2={boxes_tensor[0,3]:.0f}]")
    print(f"    Row 1: [x1={boxes_tensor[1,0]:.0f}, y1={boxes_tensor[1,1]:.0f}, x2={boxes_tensor[1,2]:.0f}, y2={boxes_tensor[1,3]:.0f}]")

...
for image_id, image_filename in enumerate(images):
    ...
    for class_id in numclasses:
        ...
        annotation_info = ann_from_mask_rle(
            segmentation_id, image_id, class_id, binary_mask, iscrowd=0
        )
...
with open(
    "/Users/ziyaoshang/Desktop/MEproject/DAFormer/data/source/envy_coco.json", "w"
) as f:

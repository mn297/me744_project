...
rcnn_out = sorted(glob.glob(os.path.join("/Users/ziyaoshang/Desktop/MEproject/DAFormer/data/source/mixed/test_common/rcnn_out", "*.pkl"), recursive=True))
unet_out = sorted(glob.glob(os.path.join("/Users/ziyaoshang/Desktop/MEproject/DAFormer/data/source/mixed/test_common/results", "*.npy"), recursive=True))
